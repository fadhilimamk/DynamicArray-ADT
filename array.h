...
/*  Kamus Umum */
/* tidak ada deklarasi konstanta IdxMax */
#define IdxMin 1
...
typedef struct {
	ElType * TI; 	/* alokasi array dinamik */
	int Neff; 		/* >=0, banyaknya elemen efektif */
	int MaxEl; 		/* ukuran elemen */
} TabInt;
/* Indeks container TI yang digunakan adalah dari indeks ke-1 s.d. ??? */
/* Indeks ke-0 dapat digunakan sebagai sentinel */
/* Jika T adalah TabInt, cara deklarasi dan akses: */
/* Deklarasi : T : TabInt */
/* Maka cara akses:
   T.Neff  untuk mengetahui banyaknya elemen
   T.MaxEl untuk mengetahui banyaknya elemen yang dapat ditampung
   T.TI    untuk mengakses seluruh nilai elemen tabel
   T.TI[i] untuk mengakses elemen ke-i */
/* Definisi :
  Tabel kosong: T.Neff = 0; T.MaxEl = 0;
...
/* selektor ukuran maksimum T */
#define Neff(T) (T).Neff
/* selektor nilai efektif T */
